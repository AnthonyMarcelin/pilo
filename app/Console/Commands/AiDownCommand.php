...
class AiDownCommand extends Command
{
    ...
    protected $description = "Arrête les conteneurs IA (paddleocr + ollama) pour libérer la RAM";
    ...
    public function handle(): int
    {
        ...
        $dir = base_path();
        exec("cd {$dir} && docker compose --profile ai stop paddleocr ollama 2>&1", $output, $code);
